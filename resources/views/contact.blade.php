...
<head>
    ...
    @include('partials.seo', [
        ...
        'seoDescription' => 'Talk to Akash Tourism about your next journey through Delhi, Agra, Jammu & Kashmir, or Himachal Pradesh.',
        'seoType' => 'website',
        'seoSchema' => [
...
<div class="site-shell">
    ...
    <header class="site-header">
        <a class="brand" href="{{ url('/') }}" aria-label="Akash Tourism home">
            <span class="brand-mark">A</span><span>Akash Tourism</span>
        </a>
        ...
        <div class="header-actions">
            ...
            <button class="menu-toggle" type="button" aria-expanded="false" aria-controls="mobile-nav" aria-label="Toggle menu">
                <span></span><span></span>
            </button>
        </div>
    </header>
    ...
    <main>
        <section class="contact-hero">
            <div>
                ...
                <p>Tell us what you are dreaming about. A slow week in the hills, a food-filled city break, or something you have not imagined yet.</p>
            ...
            <div class="contact-card">
                ...
                <form action="{{ route('contact.submit') }}" method="post">
                    ...
                    <input id="contact-name" name="name" type="text" value="{{ old('name') }}" placeholder="What should we call you?" required>

                    <label for="contact-email">Email address</label>
                    <input id="contact-email" name="email" type="email" value="{{ old('email') }}" placeholder="you@example.com" required>
        ...
        <section class="contact-note">
            ...
            <p>We read every message ourselves and will come back with a few thoughtful questions before suggesting a route.</p>
        </section>
    </main>
